...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description='Loads FITs spectrum file and plots it.')
	parser.add_argument('inputFile', type=str, nargs="+", help='Name of the input file.')
	parser.add_argument('-p', '--pause', type=float, default=1.0, help="Number of seconds to pause on each plot.")
